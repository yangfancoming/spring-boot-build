...
/**
 * Default user {@link Configuration} for a reactive web application. Configures a {@link ReactiveUserDetailsService} with a default user and generated password.
 * This backs-off completely if there is a bean of type {@link ReactiveUserDetailsService} or {@link ReactiveAuthenticationManager}.
 */
@Configuration
