...
public class WebMvcAutoConfiguration {
	...
	public static class WebMvcAutoConfigurationAdapter implements WebMvcConfigurer, ResourceLoaderAware {
		...
		public WebMvcAutoConfigurationAdapter(ResourceProperties resourceProperties,WebMvcProperties mvcProperties, ListableBeanFactory beanFactory,
		...
		//注入 messageConverters
		//此处注入了ByteArrayHttpMessageConverter、StringHttpMessageConverter、ResourceHttpMessageConverter、SourceHttpMessageConverter、AllEncompassingFormHttpMessageConverter
		//在 HttpMessageConvertersAutoConfiguration 类中，还引入了GsonAutoConfiguration和JacksonAutoConfiguration
		...
		// 通过设置前缀、后缀，以及控制器中方法来返回视图名字符串 以得到实际页面
		@Bean
		...
		// 在控制器中的一个方法返回值的字符串（视图名）会根据BeanNameViewResolver去查找Bean的名称为返回字符串的View来渲染视图
		@Bean
		...
		public ContentNegotiatingViewResolver viewResolver(BeanFactory beanFactory) {
			...
			// ContentNegotiatingViewResolver不是自己处理View，而是代理不同的ViewResolver来处理不同的View它有最高的优先级
		...
		//只要定义了Converter、GenericConverter和Formatter接口的实现类，这些Bean就会自动注册到Spring MVC中
		@Override
