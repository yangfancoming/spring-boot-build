...
public class DataSourceAutoConfigurationTests {
	...
	private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
			...
			.withPropertyValues("spring.datasource.initialization-mode=never","spring.datasource.url:jdbc:hsqldb:mem:testdb-" + new Random().nextInt());
	...
	public void testBadDriverClass() {
		this.contextRunner
				.withPropertyValues("spring.datasource.driverClassName:org.none.jdbcDriver")
	...
	public void explicitTypeSupportedDataSource() {
		this.contextRunner
				.withPropertyValues("spring.datasource.driverClassName:org.hsqldb.jdbcDriver","spring.datasource.url:jdbc:hsqldb:mem:testdb","spring.datasource.type:" + SimpleDriverDataSource.class.getName())
				.run(this::containsOnlySimpleDriverDataSource);
	}
	...
	public void testDataSourceIsInitializedEarly() {
		this.contextRunner
				...
				.run((context) -> assertThat(context.getBean(TestInitializedDataSourceConfiguration.class).called).isTrue());
	}
