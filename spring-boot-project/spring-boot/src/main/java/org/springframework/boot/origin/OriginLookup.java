...
public interface OriginLookup<K> {
	...
	/**
	 * Return the origin of the given key or {@code null} if the origin cannot be determined.
	 ...
	 * {@link OriginLookup} or if an exception occurs during lookup then {@code null} is returned.
